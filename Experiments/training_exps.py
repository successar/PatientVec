...
def basic_experiments(data, args) :
    train_data = data.filter_data_length(data.get_data('train', structured=True), truncate=90)
    dev_data = data.filter_data_length(data.get_data('dev', structured=True), truncate=90)
...
def structured_attention_experiments(data, args) :
    train_data = data.filter_data_length(data.get_data('train', structured=True, encodings=data.structured_columns), truncate=90)
    dev_data = data.filter_data_length(data.get_data('dev', structured=True, encodings=data.structured_columns), truncate=90)
