...
experiments = [LSTM, Average, CNN, LSTM_with_attention, Average_with_attention, CNN_with_attention]
hierarchical_experiments =  [Hierarchical_LSTM_with_attention]
...
structured_experiments = [Average_with_conditional_attention, LSTM_with_conditional_attention, CNN_with_conditional_attention]