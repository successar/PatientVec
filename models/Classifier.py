...
class VectorClassifier(nn.Module, from_params.FromParams):
    def __init__(self, decoder: FeedForward, predictor: Predictor, structured: Dict):
        super().__init__()
    ...
    def from_params(cls, params: Params):
        ...
        return cls(decoder=decoder, predictor=predictor, structured=params.pop("structured"))


@Model.register("seq_classifier")
class SequenceClassifier(nn.Module, from_params.FromParams):
    def __init__(self, embedder: Embedder, encoder: Encoder, decoder: FeedForward, predictor: Predictor, structured: Dict):
        super().__init__()
...
class SequenceClassifierWithAttention(nn.Module, from_params.FromParams):
    def __init__(self, embedder: Embedder, encoder: Encoder, decoder: FeedForward, attention: SelfAttention, predictor: Predictor, structured: Dict):
        super().__init__()
        self.embedding = embedder
        self.encoder = encoder
        self.decoder = decoder
...
class SequenceClassifierWithStructuredAttention(nn.Module, from_params.FromParams):
    def __init__(self, embedder: Embedder, encoder: Encoder, decoder: FeedForward, attention: Attention, predictor: Predictor, structured: Dict):
        super().__init__()
        self.embedding = embedder
        self.encoder = encoder
        self.decoder = decoder
