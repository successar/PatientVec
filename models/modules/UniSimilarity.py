...
class UniAdditiveSimilarity(UniSimilarity) :
    def __init__(self, tensor_1_dim, hidden_size, activation:Activation = Activation.by_name('tanh')) :
...
class UniScaledDotSimilarity(UniSimilarity) :
    def __init__(self, tensor_1_dim) :
        super(UniScaledDotSimilarity, self).__init__()
        self.tensor_1_dim = tensor_1_dim
        self.linear_1 = nn.Linear(tensor_1_dim, 1)
